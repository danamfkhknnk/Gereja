...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="relative w-full h-screen">
     <div class="absolute inset-0 flex backdrop-blur-md flex-col justify-center text-center items-center  z-20">
        <form class="md:w-1/3 max-w-sm bg-secondary/75 p-10 rounded-xl shadow-lg" action="{{url('/aksilogin')}}" method="POST">
            @csrf          
            ...
            <input class="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded" type="text" placeholder="Username" name="text" value="{{ old('username')}}" autoFocus />
