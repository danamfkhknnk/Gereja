     ...
     @foreach ($penguruses as $pengurus)
          <tr class="bg-white border-b  hover:bg-gray-50 ">
              ...
              <td class="flex px-6 py-4">
                <a href={{url('admin/pengurus/'.$pengurus->id.'/edit')}} class="font-medium text-blue-600  hover:underline">
                        ...
                        <div class="p-3">
                          <svg class="mx-auto mb-2 text-gray-400 w-12 h-12 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                             <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                              ...
                              <h2 class="font-semibold text-lg mb-2 text-dark">Yakin Ingin Hapus <b>{{$pengurus->posisi}}</b> ?</h2>    
